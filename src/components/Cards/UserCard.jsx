  ...
  return (
    <div className="flex justify-between items-center border-t-[1px] border-customGray py-[0.7rem]">
          <div className="flex items-center gap-[1rem]">
            <ProfileTooltip>
              <Avatar className="w-[2rem] h-[2rem] relative before:content-[''] before:w-[10px] before:h-[10px] before:bg-green-600 before:absolute before:bottom-[-1px] before:right-[-1px] before:z-[20] before:rounded-full before:border before:border-primary overflow-visible">
                  <AvatarImage
